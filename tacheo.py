...
def init_db():
    conn = sqlite3.connect('tacheo_auth.db')
    c = conn.cursor()
...
app.config['DATABASE'] = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'tacheo_auth.db')
...
if __name__ == '__main__':
    ...
    db_exists = os.path.exists('tacheo_auth.db')
    
    if not db_exists:
        print("Création de la base de données tacheo_auth.db...")
        init_db()
    ...
    print("💾 Base de données: tacheo_auth.db")
    print("📸 Dossier des photos: static/uploads/")
    print("✨ CORRECTIONS APPLIQUÉES:")
    print("   1. Aperçu IMMÉDIAT de la photo dans le cercle de profil")
    print("   2. Nom du fichier remplace 'Choisir un fichier' dès la sélection")
    print("   3. Animation de chargement pendant l'aperçu")
    print("   4. Validation en temps réel du type et taille de fichier")
    print("   5. Message de confirmation pour la sélection réussie")
    print("✅ Toutes vos demandes ont été implémentées avec succès!")
